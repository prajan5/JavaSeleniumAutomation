...
//create Lead and then Edit Lead through XML, if create leads fail, edit lead will not be executed
	@Test(dependsOnMethods= {"testNGAttributes.CreateLead2.runcreate_Lead"})
